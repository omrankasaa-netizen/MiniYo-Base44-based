      ...
      <section className="border-b border-border/50 bg-card">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          ...
          <div className="flex flex-wrap gap-2.5 mb-6">
            <Link to="/shop?sort=new" className="min-h-[44px] px-6 rounded-full bg-primary text-primary-foreground text-sm font-semibold inline-flex items-center justify-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-2.5">
            {TRUST_POINTS.map(({ icon: Icon, en, ar }) => (
              <div key={en} className="rounded-2xl border border-border bg-background p-3.5 flex items-center gap-2.5">
