              ...
              >
                ...
                >
                  <div className="w-36 h-36 sm:w-44 sm:h-44 rounded-3xl overflow-hidden bg-accent/20 border border-border/60 shadow-sm group-hover:shadow-md group-hover:-translate-y-1 transition-all duration-300">
                    {cat.image_url
                      ? <img src={cmsImageSrc(cat.image_url, 'card')} srcSet={cmsImageSrcSet(cat.image_url)} sizes="(max-width: 640px) 144px, 176px" alt={name} width={176} height={176} loading="lazy" decoding="async" onError={handleImageError} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
