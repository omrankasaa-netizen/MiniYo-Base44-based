  ...
  const content = (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
      ...
      <div className="aspect-[16/4] sm:aspect-[16/3] w-full bg-muted">
        {section.image_url
          ? <img src={cmsImageSrc(section.image_url, 'large')} srcSet={cmsImageSrcSet(section.image_url)} sizes="(max-width: 1280px) 100vw, 1248px" alt={title} width={1280} height={320} loading="lazy" decoding="async" onError={handleImageError} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
